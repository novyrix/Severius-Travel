...
export function Footer() {
  ...
  const footerLinks = {
    ...
    destinations: [
      { name: "Kenya Tours", href: "/tours?country=KE" },
      { name: "Tanzania Tours", href: "/tours?country=TZ" },
      { name: "Uganda Tours", href: "/tours?country=UG" },
      { name: "Rwanda Tours", href: "/tours?country=RW" },
      { name: "South Africa Tours", href: "/tours?country=ZA" },
